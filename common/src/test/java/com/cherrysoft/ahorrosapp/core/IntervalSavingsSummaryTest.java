...
class IntervalSavingsSummaryTest {
  ...
  void whenNoSavings_thenTotalAndAverageAmountAreZero() {
    ...
    assertEquals(BigDecimal.ZERO, intervalSavingsSummary.calcSavingsTotalAmount());
    assertEquals(BigDecimal.ZERO, intervalSavingsSummary.calcAverageAmount());
  }
  ...
  void calculatesTotalAndAverageAmount() {
    ...
    assertEquals(BigDecimal.valueOf(3100.0), intervalSavingsSummary.calcSavingsTotalAmount());
    assertEquals(BigDecimal.valueOf(100.0), intervalSavingsSummary.calcAverageAmount());
  }
